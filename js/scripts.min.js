...
$(function () {
    $(".main__carousel").owlCarousel({
        ...
        autoplay: !0,
        smartSpeed: 700
    }), $(".thanks-letters__slider").owlCarousel({
        items: 5,
        loop: !0,
        autoplay: !0,
        smartSpeed: 700,
        ...
        responsive: {0: {items: 1}, 600: {items: 2}, 900: {items: 3}, 1190: {items: 4}, 1470: {items: 5}}
    }), $(".panel_heading .block_title").click(function () {
        $(this).toggleClass("in").next().slideToggle(), $(".panel_heading .block_title").not(this).removeClass("in").next().slideUp()
    }), $("body").on("click", ".top", function () {
        $("html, body").animate({scrollTop: 0}, "slow")
    }), $(window).scroll(function () {
        200 < $(this).scrollTop() ? $(".top").addClass("fixed") : $(".top").removeClass("fixed")
    }),
...
// модальное окно форма обратной связи end
